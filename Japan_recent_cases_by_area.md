...
実効再生産数は，[国立感染症研究所](https://www.niid.go.jp/niid/ja/2019-ncov/2502-idsc/iasr-in/10465-496d04.html)で提案されている以下の式で算出：
「t日の実効再生産数」=「(t-6)日〜t日の7日間新規感染者数」÷「(t-g-6)日〜(t-g)日の7日間新規感染者数」  
g: 平均世代時間(ただし，2022/08/26以降はオミクロン株の性質を踏まえて平均世代時間gを5日→2日に変更）
